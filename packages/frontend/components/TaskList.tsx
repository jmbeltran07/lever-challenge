  ...
  return (
    <div>
      <div
        ...
        `}
      >
        <Button content="Create new" color="blue" onClick={() => setAddTaskModalOpen(true)} />
        <Button basic content="Category configuration" color="blue" onClick={() => setCategoryModalOpen(true)} />
      </div>
      <div>
        {tasksData.map((task) => {
